...
from inspiration_one_backend.application.auth import auth_tables_available, ensure_auth_bootstrapped
...
from inspiration_one_backend.presentation.routes.public import router as public_router
