...
class OpenAIImagesClient:
    ...
    def _with_inspiration_one_metadata(
        self,
        ...
        *,
        ...
        metadata = dict(output.get("_inspiration_one") or {})
        if notes:
    ...
    def generate(
        ...
        *,
        ...
        try:
            ...
            fallback_used = True
            fallback_params = {key: value for key, value in request_params.items() if key not in {"quality", "style"}}
            try:
        ...
        provider_output_json = self._with_inspiration_one_metadata(
            None,
