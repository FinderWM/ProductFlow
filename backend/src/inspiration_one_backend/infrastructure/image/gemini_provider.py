...
def map_inspiration_one_size_to_gemini_image_config(
    size: str,
    model: str,
    *,
...
class GoogleGeminiImageClient:
    ...
    def generate_image(
        ...
        *,
        ...
        client = self._client()
        image_config = map_inspiration_one_size_to_gemini_image_config(
            size,
            self.model,
        ...
        inspiration_one_metadata: dict[str, Any] = {
            "model": self.model,
            "requested_size": size,
            "effective_aspect_ratio": image_config.aspect_ratio,
        }
        if image_config.image_size:
            inspiration_one_metadata["effective_image_size"] = image_config.image_size
        if image_config.notes:
            inspiration_one_metadata["notes"] = image_config.notes

        output_json = {
            "response_id": response_id,
            "model_version": model_version,
            "text_part_count": len(text_parts),
            "_inspiration_one": inspiration_one_metadata,
        }
