...
def _headline_from_payload(payload: PosterGenerationInput) -> str:
    ...
    return payload.inspiration_name
...
class PosterRenderer:
    ...
    def _render_main_image(self, payload: PosterGenerationInput) -> Image.Image:
        ...
        if payload.source_image is not None:
            inspiration_img = _fit_source_image(payload.source_image, (760, 540))
            canvas.alpha_composite(inspiration_img, (160, 330))
    ...
    def _render_promo_poster(self, payload: PosterGenerationInput) -> Image.Image:
        ...
        _draw_wrapped_text(draw, payload.inspiration_name, body_font, (70, 260, 700, 340), (230, 230, 230))

        if payload.source_image is not None:
            inspiration_img = _fit_source_image(payload.source_image, (700, 640))
            canvas.alpha_composite(inspiration_img, (190, 560))
