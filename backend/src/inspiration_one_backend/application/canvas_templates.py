...
class CanvasTemplateDefaultExternalConnection(BaseModel):
    ...
    source: Literal["existing_inspiration_context"]
    target_node_key: str
    label: str
    reason: str
...
def validate_canvas_template(template: CanvasTemplate) -> None:
    ...
    for node in template.nodes:
        ...
        if template.kind == "node_group" and node.node_type == WorkflowNodeType.INSPIRATION_CONTEXT:
    ...
    for connection in template.suggested_connections:
        ...
        if connection.source_node_key not in nodes_by_key or connection.target_node_key not in nodes_by_key:
...
def _default_inspiration_connection(target: str) -> CanvasTemplateDefaultExternalConnection:
    return CanvasTemplateDefaultExternalConnection(
        source="existing_inspiration_context",
        target_node_key=target,
        label="自动接灵感产物",
        reason="沿用当前画布的灵感产物资料和灵感产物主图。",
    )
...
def _spread_full_canvas_columns(nodes: tuple[CanvasTemplateNodeSpec, ...]) -> tuple[CanvasTemplateNodeSpec, ...]:
    ...
    column_positions = {
        column_x: origin_x + index * FULL_CANVAS_TEMPLATE_COLUMN_GAP for index, column_x in enumerate(sorted_columns)
    }
    ...
    *,
    ...
    return CanvasTemplate(
        ...
        default_external_connections=(
            _default_inspiration_connection("copy"),
            _default_inspiration_connection("image"),
        ),
    )


_MAIN_IMAGE_COPY = "提炼灵感产物核心卖点，文案适合电商主图，控制为简洁标题和 3 个利益点。"
_MAIN_IMAGE_INSTRUCTION = "生成干净、聚焦灵感产物主体的电商主图，主体清晰，卖点可被视觉表达。"

_TAOBAO_COPY = "提炼适合淘宝主图的核心卖点，突出灵感产物主体、适用人群和购买理由，控制为短标题和 3 个利益点。"
_TAOBAO_IMAGE = "生成淘宝主图，1:1 构图，灵感产物主体清晰居中，背景干净，卖点视觉明确，避免复杂文字堆叠。"

_XHS_COPY = "提炼适合小红书笔记封面的内容角度，突出使用体验、场景氛围和真实感，避免硬广语气。"
_XHS_IMAGE = "生成小红书风格竖版图片，画面自然、有生活感，灵感产物清楚可见，适合笔记封面和种草内容。"

_MULTI_ANGLE_COPY = "规划灵感产物多角度展示顺序，覆盖正面、侧面、背面或关键结构，保持说明短而明确。"
_MULTI_ANGLE_IMAGE = "生成同一灵感产物的多角度展示图，主体比例一致，角度清楚，适合详情页轮播和平台图册。"

_SKU_COPY = "围绕当前 SKU 的颜色、规格、容量或组合差异生成简短说明，突出用户选择时最需要比较的信息。"
_SKU_IMAGE = "生成突出 SKU 差异的灵感产物图，保持主体一致，明确展示规格、颜色或组合差别。"

_FEATURE_INFOGRAPHIC_COPY = "提炼 3 到 5 个最影响购买决策的功能卖点，并为每个卖点生成短标签和视觉表达建议。"
_FEATURE_INFOGRAPHIC_IMAGE = "生成灵感产物功能卖点信息图，主体清楚，卖点布局有层级，适合详情页首屏说服。"

_SIZE_SPEC_COPY = "整理灵感产物尺寸、容量、规格、材质参数和注意事项，输出适合规格说明图的结构化短文案。"
_SIZE_SPEC_IMAGE = "生成尺寸/规格说明图，保留灵感产物轮廓和关键标注区域，布局清楚，适合详情页参数说明。"

_SCALE_REFERENCE_COPY = "提炼灵感产物真实尺度、手持/佩戴/桌面参照和使用距离，避免夸大比例。"
_SCALE_REFERENCE_IMAGE = "生成带真实参照物的尺度展示图，让用户直观理解灵感产物大小、厚度或容量。"

_PACKAGE_COPY = "整理包装内容、配件清单、赠品和到手状态，形成适合清单图的短标签。"
_PACKAGE_IMAGE = "生成包装/清单平铺图，清楚展示灵感产物、包装盒、配件和数量，适合详情页到手说明。"

_USAGE_STEPS_COPY = "拆解安装、开箱、佩戴、清洁或使用步骤，控制为 3 到 4 步，每步一句短说明。"
_USAGE_STEPS_IMAGE = "生成使用步骤说明图，步骤顺序清楚，动作真实，灵感产物和关键部件可辨认。"

_COMPARISON_COPY = "提炼对比维度，适合和旧款、竞品、普通款或不同套餐做清晰对照，不做无法证实的绝对化承诺。"
_COMPARISON_IMAGE = "生成灵感产物对比图，用左右或上下结构展示差异，突出可验证的规格、功能或使用体验差别。"

_LIFESTYLE_COPY = "提炼目标人群、使用场景和生活方式氛围，避免夸张承诺。"
_LIFESTYLE_IMAGE = "生成自然生活方式图，让灵感产物在真实使用场景中清楚可见，人物或环境服务于灵感产物。"

_SCENE_COPY = "提炼灵感产物适合的使用场景、搭配对象和环境关键词。"
_SCENE_IMAGE = "生成灵感产物使用场景图，环境真实可信，灵感产物仍是画面主体。"

_DETAIL_COPY = "提炼灵感产物材质、工艺、结构和功能细节，形成短标题和说明点。"
_DETAIL_IMAGE = "生成细节或材质特写图，强调纹理、结构和功能点，避免失真。"

_CAMPAIGN_COPY = "生成活动图文案，突出优惠、时效和灵感产物利益点，语气明确但不过度承诺。"
_CAMPAIGN_IMAGE = "生成活动促销灵感产物图，保留灵感产物主体，增加促销氛围和明确视觉层级。"
...
_WHITE_BACKGROUND_COPY = "提炼白底图需要保留的灵感产物主体、角度和规格重点，不添加促销语。"
_WHITE_BACKGROUND_IMAGE = "生成白底灵感产物图，纯净背景，灵感产物边缘清晰，保持真实比例和材质。"
...
BUILTIN_CANVAS_TEMPLATES: tuple[CanvasTemplate, ...] = (
    _full_canvas_template(
        ...
        nodes=(
            _node("inspiration", WorkflowNodeType.INSPIRATION_CONTEXT, title="灵感产物资料", x=48, y=132),
            _node(
                "copy",
                WorkflowNodeType.COPY_GENERATION,
                title="主图卖点",
        ...
        output_slots=(
            _output_slot("output", "主图输出", "灵感产物列表和详情首图候选。"),
            _output_slot("refined_output", "细化输出", "主图细化版本候选。"),
        ),
        suggested_connections=(
            _suggest("inspiration", "copy", "灵感产物资料为主图卖点提供基础信息。"),
    ...
    _full_canvas_template(
        ...
        title="淘宝主图",
        description="生成适合淘宝搜索、推荐和详情首屏的 1:1 灵感产物主图。",
        scenario=_scenario(
        ...
        nodes=(
            ...
            _node(
                ...
                x=640,
                y=208,
                instruction_seed="生成更克制的淘宝主图版本，减少装饰元素，优先保证灵感产物主体和边缘清晰。",
                size="1024x1024",
            ),
            _node(
                "clean_output",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node("inspiration", WorkflowNodeType.INSPIRATION_CONTEXT, title="灵感产物资料", x=48, y=200),
            _node(
                "angle",
                WorkflowNodeType.COPY_GENERATION,
                title="封面角度",
    ...
    _full_canvas_template(
        ...
        nodes=(
            _node("inspiration", WorkflowNodeType.INSPIRATION_CONTEXT, title="灵感产物资料", x=48, y=168),
            _node(
                "angle_plan",
                WorkflowNodeType.COPY_GENERATION,
                title="角度规划",
            ...
            _node(
                ...
                x=680,
                y=180,
                instruction_seed="生成同一灵感产物的侧面或 45 度角展示图，比例和材质与正面保持一致。",
                size="1024x1024",
            ),
            _node(
                "side_output",
            ...
            _node(
                ...
                x=680,
                y=312,
                instruction_seed="生成同一灵感产物的背面、底部或关键结构角度，强调真实结构和比例。",
                size="1024x1024",
            ),
            _node(
                "back_output",
        ...
        edges=(
            ("inspiration", "angle_plan"),
            ("inspiration", "front_image"),
            ("angle_plan", "front_image"),
            ("front_image", "front_output"),
            ("inspiration", "side_image"),
            ("angle_plan", "side_image"),
            ("side_image", "side_output"),
            ("inspiration", "back_image"),
        ...
        suggested_connections=(
            ...
            _suggest("angle_plan", "back_image", "同一规划约束背面或结构图不偏离灵感产物主体。"),
        ),
    ),
    _full_canvas_template(
        ...
        nodes=(
            _node(
                ...
                x=48,
                y=48,
                config_json={"role": "inspiration_reference", "label": "SKU 参考图"},
                reference_input_hint="上传目标 SKU、颜色或规格的参考图。",
            ),
            _node("inspiration", WorkflowNodeType.INSPIRATION_CONTEXT, title="灵感产物资料", x=48, y=204),
            _node(
                "variant_copy",
                WorkflowNodeType.COPY_GENERATION,
                title="变体差异",
    ...
    _full_canvas_template(
        ...
        title="功能卖点图",
        description="把灵感产物核心功能转成有层级的信息图，用于详情页首屏说服。",
        scenario=_scenario(
        ...
        nodes=(
            _node("inspiration", WorkflowNodeType.INSPIRATION_CONTEXT, title="灵感产物资料", x=48, y=176),
            _node(
                "feature_copy",
                WorkflowNodeType.COPY_GENERATION,
                title="卖点提炼",
        ...
        edges=(
            ("inspiration", "feature_copy"),
            ("inspiration", "layout_copy"),
        ...
        output_slots=(_output_slot("infographic_output", "卖点图输出", "详情页功能卖点说明图候选。"),),
        suggested_connections=(
    ...
    _full_canvas_template(
        ...
        edges=(
            ("inspiration", "spec_copy"),
            ("inspiration", "dimension_image"),
            ("spec_copy", "dimension_image"),
            ("dimension_image", "dimension_output"),
            ("inspiration", "spec_table_image"),
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node("inspiration", WorkflowNodeType.INSPIRATION_CONTEXT, title="灵感产物资料", x=48, y=212),
            _node(
                "scale_copy",
                WorkflowNodeType.COPY_GENERATION,
                title="尺度说明",
            ...
            _node(
                ...
                x=710,
                y=244,
                instruction_seed="生成桌面、墙面、背包、厨房台面或收纳空间中的尺度参照图，避免夸大灵感产物比例。",
                size="1536x1024",
            ),
            _node(
                "surface_output",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node("inspiration", WorkflowNodeType.INSPIRATION_CONTEXT, title="灵感产物资料", x=48, y=208),
            _node(
                "checklist_copy",
                WorkflowNodeType.COPY_GENERATION,
                title="清单文案",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node("inspiration", WorkflowNodeType.INSPIRATION_CONTEXT, title="灵感产物资料", x=48, y=220),
            _node(
                "step_copy",
                WorkflowNodeType.COPY_GENERATION,
                title="步骤拆解",
    ...
    _full_canvas_template(
        ...
        title="模特/生活方式图",
        description="生成有人物、穿搭或生活方式氛围的灵感产物场景图。",
        scenario=_scenario(
        ...
        nodes=(
            ...
            _node(
                ...
                x=700,
                y=224,
                instruction_seed="生成强调使用动作、触感或佩戴细节的图片，灵感产物应清楚可见，氛围自然。",
                size="1024x1536",
            ),
            _node(
                "detail_usage_output",
        ...
        edges=(
            ...
            ("inspiration", "copy"),
            ("style", "half_body"),
            ("inspiration", "half_body"),
            ("copy", "half_body"),
            ("half_body", "half_body_output"),
            ("style", "detail_usage"),
            ("inspiration", "detail_usage"),
            ("copy", "detail_usage"),
    ...
    _full_canvas_template(
        ...
        title="场景图",
        description="把灵感产物放入可理解的使用空间或业务场景。",
        scenario=_scenario(
            CanvasTemplateScenario.SCENE_IMAGE,
            title="场景",
            description="用于说明灵感产物使用环境、搭配和空间关系。",
            ecommerce_stage="gallery",
        ...
        edges=(
            ...
            ("inspiration", "wide_scene"),
            ("copy", "wide_scene"),
            ("wide_scene", "scene_output"),
        ),
        output_slots=(_output_slot("scene_output", "场景图输出", "详情页图册中的使用场景图候选。"),),
        reference_input_hints=(
            _reference_hint(
                "scene_reference",
                role="scene",
        ...
        suggested_connections=(_suggest("scene_reference", "wide_scene", "场景参考直接约束空间、光线和陈列方式。"),),
    ),
    _full_canvas_template(
    ...
    _full_canvas_template(
        ...
        title="活动/促销图",
        description="生成适合活动入口、优惠表达和促销氛围的灵感产物图。",
        scenario=_scenario(
        ...
        nodes=(
            ...
            _node("inspiration", WorkflowNodeType.INSPIRATION_CONTEXT, title="灵感产物资料", x=48, y=216),
            _node(
                "offer_copy",
                WorkflowNodeType.COPY_GENERATION,
                title="优惠信息",
            ...
            _node(
                ...
                x=360,
                y=224,
                instruction_seed="整理活动图的画面层级：灵感产物主体、利益点、活动氛围和留白位置，避免信息堆满。",
            ),
            _node(
                "banner",
                WorkflowNodeType.IMAGE_GENERATION,
        ...
        edges=(
            ...
            ("inspiration", "offer_copy"),
            ("campaign_style", "visual_copy"),
            ("inspiration", "visual_copy"),
        ...
        output_slots=(_output_slot("banner_output", "活动图输出", "活动入口、促销位或广告素材候选。"),),
        reference_input_hints=(
            _reference_hint(
                "campaign_style",
                role="style",
    ...
    _full_canvas_template(
        ...
        nodes=(
            ...
            _node(
                ...
                x=360,
                y=244,
                instruction_seed="整理短视频封面的画面节奏：灵感产物特写、使用瞬间、人物视线、标题区域和安全留白。",
            ),
            _node(
                "vertical_cover",
                WorkflowNodeType.IMAGE_GENERATION,
            ...
            _node(
                ...
                x=720,
                y=276,
                instruction_seed="生成更聚焦灵感产物特写和使用瞬间的短视频封面备用版本，适合内容流快速识别。",
                size="1024x1536",
            ),
            _node(
        ...
        output_slots=(
            ...
            _output_slot("closeup_cover_output", "特写封面输出", "更聚焦灵感产物和使用瞬间的封面候选。"),
        ),
        reference_input_hints=(
            _reference_hint(
                "cover_style",
        ...
        suggested_connections=(
            ...
            _suggest("frame_copy", "closeup_cover", "画面节奏约束特写封面的标题区和灵感产物识别。"),
        ),
    ),
    _full_canvas_template(
        key="ecommerce-white-background-image-v1",
        title="白底图",
        description="生成用于平台规范、抠图或基础陈列的白底灵感产物图。",
        scenario=_scenario(
            CanvasTemplateScenario.WHITE_BACKGROUND,
            title="白底",
            description="用于平台基础灵感产物图、规格图和素材复用。",
            ecommerce_stage="listing",
        ...
        nodes=(
            _node(
                ...
                x=48,
                y=56,
                config_json={"role": "inspiration_reference", "label": "主体参考图"},
                reference_input_hint="上传需要保留外观、角度或比例的灵感产物主体参考图。",
            ),
            _node("inspiration", WorkflowNodeType.INSPIRATION_CONTEXT, title="灵感产物资料", x=48, y=212),
            _node(
                "clean_copy",
            ...
            _node(
                ...
                x=700,
                y=248,
                instruction_seed="生成浅灰或纯白背景下的轻阴影灵感产物陈列图，适合保留材质和体积感。",
                size="1024x1024",
            ),
            _node(
                "shadow_output",
        ...
        edges=(
            ("inspiration_reference", "clean_copy"),
            ("inspiration", "clean_copy"),
            ("inspiration_reference", "white_image"),
            ("inspiration", "white_image"),
            ("clean_copy", "white_image"),
            ("white_image", "white_output"),
            ("inspiration_reference", "shadow_image"),
            ("inspiration", "shadow_image"),
        ...
        reference_input_hints=(
            _reference_hint(
                ...
                role="inspiration_reference",
                label="主体参考图",
                description="上传需要保留外观、角度或比例的灵感产物主体参考图。",
            ),
        ),
        suggested_connections=(
            _suggest("inspiration_reference", "white_image", "主体参考图用于保持外观、角度和边缘细节。"),
