"""inspiration resource group semantics
...
def upgrade() -> None:
    with op.batch_alter_table("inspirations") as batch_op:
        ...
        batch_op.create_index("ix_inspirations_resource_group_id", ["resource_group_id"], unique=False)
    with op.batch_alter_table("inspirations") as batch_op:
...
def downgrade() -> None:
    with op.batch_alter_table("inspirations") as batch_op:
        batch_op.drop_index("ix_inspirations_resource_group_id")
