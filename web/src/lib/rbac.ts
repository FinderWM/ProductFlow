...
export const API_ENHANCE_READ = "enhance:read";
export const API_ENHANCE_GENERATE = "enhance:generate";
export const API_IMAGE_TO_CODE_READ = "image_to_code:read";
export const API_IMAGE_TO_CODE_GENERATE = "image_to_code:generate";
