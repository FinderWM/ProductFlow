...
export const INSPIRATION_ONE_NODE_TYPE = "inspiration-oneNode";
export const INSPIRATION_ONE_EDGE_TYPE = "inspiration-oneEdge";
export const INSPIRATION_ONE_SOURCE_HANDLE = "output";
export const INSPIRATION_ONE_TARGET_HANDLE = "input";
...
export interface InspirationOneNodeData extends Record<string, unknown> {
  workflowNode: WorkflowNode;
}

export interface InspirationOneEdgeData extends Record<string, unknown> {
...
export type InspirationOneReactFlowNode = Node<InspirationOneNodeData, typeof INSPIRATION_ONE_NODE_TYPE>;
export type InspirationOneReactFlowEdge = Edge<InspirationOneEdgeData, typeof INSPIRATION_ONE_EDGE_TYPE>;
...
export function workflowToReactFlowEdges(workflow: InspirationWorkflow): InspirationOneReactFlowEdge[] {
  return workflow.edges.map((edge) => ({
    id: edge.id,
    type: INSPIRATION_ONE_EDGE_TYPE,
    source: edge.source_node_id,
    target: edge.target_node_id,
    sourceHandle: edge.source_handle ?? INSPIRATION_ONE_SOURCE_HANDLE,
    targetHandle: edge.target_handle ?? INSPIRATION_ONE_TARGET_HANDLE,
    reconnectable: false,
    deletable: false,
    focusable: false,
    data: {
...
export function connectionToWorkflowEdgeInput(
  ...
  return {
    ...
    source_handle: connection.sourceHandle ?? INSPIRATION_ONE_SOURCE_HANDLE,
    target_handle: connection.targetHandle ?? INSPIRATION_ONE_TARGET_HANDLE,
  };
}
