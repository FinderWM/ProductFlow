import type { InspirationWorkflow, WorkflowEdge, WorkflowNode, WorkflowNodeType } from "../../lib/types";
...
export function getWorkflowStructureSignature(workflow: InspirationWorkflow): string {
